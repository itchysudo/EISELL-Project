...
class EncryptionGUI:
    def __init__(self, master, footer_text):
        ...
        # Footer Label
        self.footer_label = tk.Label(master, text=footer_text, font=self.footer_font, bg=self.colors["dark"]["bg"], fg=self.colors["dark"]["fg"])
    ...
    def open_encrypt_window(self):
        ...
        self.plaintext_entry = tk.Text(encrypt_window, width=50, height=5, font=self.custom_font, bg="black", fg="white", insertbackground="white")
        self.plaintext_entry.pack()
        self.plaintext_entry.focus_set()  # Set focus to the text entry widget
        ...
        self.key_entry = tk.Entry(encrypt_window, font=self.custom_font, bg="black", fg="white", insertbackground="white")
        self.key_entry.pack()
    ...
    def open_decrypt_window(self):
        ...
        self.ciphertext_entry = tk.Text(decrypt_window, width=50, height=5, font=self.custom_font, bg="black", fg="white", insertbackground="white")
        self.ciphertext_entry.pack()
        self.ciphertext_entry.focus_set()  # Set focus to the text entry widget
        ...
        self.key_entry = tk.Entry(decrypt_window, font=self.custom_font, bg="black", fg="white", insertbackground="white")
        self.key_entry.pack()
