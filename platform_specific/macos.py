...
class EncryptionGUI:
    def __init__(self, master):
        ...
        self.vigenere_encrypt = vigenere_encrypt
        self.vigenere_decrypt = vigenere_decrypt

        self.custom_font = font.Font(family="Consolas", size=14)  # Adjusted for macOS
        self.title_font = font.Font(family="Consolas", size=16, weight="bold")  # Adjusted for macOS
        self.footer_font = font.Font(family="Consolas", size=10)  # Adjusted for macOS
        ...
        master.config(bg=self.colors["dark"]["bg"])
        ...
        self.style.configure('Dark.TButton', font=('Consolas', 12), background=self.colors["dark"]["button_bg"], foreground=self.colors["dark"]["button_fg"])
        self.style.map('Dark.TButton',
                       foreground=[('pressed', 'black'), ('active', 'black')],
                       background=[('pressed', '!disabled', self.colors["dark"]["button_bg"]), ('active', self.colors["dark"]["button_bg"])])

        button_width = 25  # Adjusted for macOS
        ...
        self.footer_label = tk.Label(master, text="Created by ItchySudo. MacOS v1.2", font=self.footer_font, bg=self.colors["dark"]["bg"], fg=self.colors["dark"]["fg"])
    ...
    def open_encrypt_window(self):
        ...
        encrypt_window.config(bg=self.colors["dark"]["bg"])
    ...
    def encrypt_message(self, encrypt_window):
        ...
        encrypted_message = self.vigenere_encrypt(plaintext, key)
    ...
    def open_decrypt_window(self):
        ...
        decrypt_window.config(bg=self.colors["dark"]["bg"])
    ...
    def decrypt_message(self, decrypt_window):
        ...
        decrypted_message = self.vigenere_decrypt(ciphertext, key)
